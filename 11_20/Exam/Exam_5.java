/*
 * 실습문제 5
 * "C:\\java\\workspace\\class11_20\\open.png"이미지를 그래픽으로 컨텐트팬의
...
public class Exam_5 extends JFrame {
    private Image image;
    ...
    public Exam_5() {
        ...
        // 이미지 불러오기
        image = Toolkit.getDefaultToolkit().getImage("C:\\java\\workspace\\class11_20\\open.png");
