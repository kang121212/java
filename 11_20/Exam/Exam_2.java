/*
 * 실습문제 2
 * 문제 1번에서 주어진 이미지를 배경으로 출력하고 그 위에 반지름이 20 픽셀인 원을 그리고,
...
public class Exam_2 extends JFrame {
    ...
    public Exam_2() {
        ...
        // 이미지 불러오기
        File imgFile = new File("C:\\java\\workspace\\class11_20\\open.png");
        if (imgFile.exists()) {
            backgroundIcon = new ImageIcon("C:\\java\\workspace\\class11_20\\open.png");
        } else {
