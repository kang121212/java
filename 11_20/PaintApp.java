...
class PaintFrame extends JFrame {
    ...
    private JToolBar buildToolBar() {
        ...
        JButton saveButton = createIconButton(
            "C:\\java\\workspace\\class11_20\\save.png", "저장", () -> canvas.saveImage()
        );
        JButton openButton = createIconButton(
            "C:\\java\\workspace\\class11_20\\open.png", "열기", () -> canvas.openImage()
        );
        JButton newButton = createIconButton(
            "C:\\java\\workspace\\class11_20\\pen.png", "새로 만들기", () -> canvas.clear()
        );
